...
from dext.model.marine_debris_ssd_autoencoder.ssd_autoencoder import (
    SSD_Autoencoder)


@gin.configurable
def marine_debris_ssd_autoencoder(weight_path, backbone_folder):
    model = SSD_Autoencoder(12, weight_folder=backbone_folder)
    model.load_weights(weight_path)
    return model


def marine_debris_ssd_autoencoder_preprocess(image, image_size=96,
                                             only_resize=False):
...
def marine_debris_ssd_autoencoder_postprocess(
