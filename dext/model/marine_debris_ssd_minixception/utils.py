...
from dext.model.marine_debris_ssd_minixception.ssd_minixception import (
    SSD_MiniXception)


@gin.configurable
def marine_debris_ssd_minixception(weight_path, backbone_folder):
    model = SSD_MiniXception(12, weight_folder=backbone_folder)
    model.load_weights(weight_path)
    return model


def marine_debris_ssd_minixception_preprocess(image, image_size=96,
                                             only_resize=False):
...
def marine_debris_ssd_minixception_postprocess(
