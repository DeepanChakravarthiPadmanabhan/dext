...
def SSD300NoPool(num_classes=81, base_weights='VOC', head_weights='VOC',
    ...
    conv2_1 = Conv2D(128, (3, 3), padding='same', activation='relu',
                     kernel_regularizer=l2(l2_loss),
                     trainable=trainable_base,
                     name='conv2_1')(conv1_3)
    conv2_2 = Conv2D(128, (3, 3), padding='same', activation='relu',
                     kernel_regularizer=l2(l2_loss),
                     trainable=trainable_base,
                     name='conv2_2')(conv2_1)
    conv2_3 = Conv2D(128, (2, 2), strides=(2, 2), activation='relu',
                     padding='same', kernel_regularizer=l2(l2_loss),
                     trainable=trainable_base, name='conv2_3')(conv2_2)

    # Block 3 -----------------------------------------------------------------
    conv3_1 = Conv2D(256, (3, 3), padding='same', activation='relu',
                     kernel_regularizer=l2(l2_loss),
                     trainable=trainable_base,
                     name='conv3_1')(conv2_3)
    ...
    conv3_4 = Conv2D(256, (2, 2), strides=(2, 2), activation='relu',
                     padding='same', kernel_regularizer=l2(l2_loss),
                     trainable=trainable_base, name='conv3_4')(conv3_3)

    # Block 4 -----------------------------------------------------------------
    conv4_1 = Conv2D(512, (3, 3), padding='same', activation='relu',
                     kernel_regularizer=l2(l2_loss),
                     trainable=trainable_base,
                     name='conv4_1')(conv3_4)
    ...
    conv4_4 = Conv2D(512, (2, 2), strides=(2, 2), activation='relu',
                     padding='same', kernel_regularizer=l2(l2_loss),
                     trainable=trainable_base, name='conv4_4')(conv4_3)

    # Block 5 -----------------------------------------------------------------
    conv5_1 = Conv2D(512, (3, 3), padding='same', activation='relu',
                     kernel_regularizer=l2(l2_loss),
                     trainable=trainable_base,
                     name='conv5_1')(conv4_4)
    ...
    conv5_4 = Conv2D(512, (3, 3), strides=(1, 1), activation='relu',
                     padding='same', kernel_regularizer=l2(l2_loss),
                     trainable=trainable_base, name='conv5_4')(conv5_3)

    # Dense 6/7 --------------------------------------------------------------
    pool5z = ZeroPadding2D(padding=(6, 6))(conv5_4)
