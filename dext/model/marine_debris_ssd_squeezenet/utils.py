...
from dext.model.marine_debris_ssd_squeezenet.ssd_squeezenet import (
    SSD_SqueezeNet)


@gin.configurable
def marine_debris_ssd_squeezenet(weight_path, backbone_folder):
    model = SSD_SqueezeNet(12, weight_folder=backbone_folder)
    model.load_weights(weight_path)
    return model


def marine_debris_ssd_squeezenet_preprocess(image, image_size=96,
                                             only_resize=False):
...
def marine_debris_ssd_squeezenet_postprocess(
