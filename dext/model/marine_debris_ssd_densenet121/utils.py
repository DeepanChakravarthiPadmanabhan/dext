...
from dext.model.marine_debris_ssd_densenet121.ssd_densenet121 import (
    SSD_DenseNet121)


@gin.configurable
def marine_debris_ssd_densenet121(weight_path, backbone_folder):
    model = SSD_DenseNet121(12, weight_folder=backbone_folder)
    model.load_weights(weight_path)
    return model


def marine_debris_ssd_densenet121_preprocess(image, image_size=96,
                                             only_resize=False):
...
def marine_debris_ssd_densenet121_postprocess(
