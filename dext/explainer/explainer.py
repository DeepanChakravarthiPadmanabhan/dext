...
def explainer(model_name, explain_mode, input_image_path, image_size, layer_name,
    ...
    explain_model(model_name, explain_mode, input_image_path, image_size, layer_name,
                  explaining, interpretation_method, visualize_object,
