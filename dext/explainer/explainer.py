...
@click.option("--input_image_path", default="/media/deepan/externaldrive1/project_repos/DEXT_versions/dext/images/000000309391.jpg")
...
def explainer(model_name, input_image_path, interpretation_method, layer_name,
    ...
    explain_model(model_name, input_image_path, interpretation_method, layer_name, visualize_object)
